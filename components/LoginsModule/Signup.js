...
const Signup=(props)=>{
    ...
    return(
     <View style={styles.MainContainer}>
         ...
         <FontAwesome name="user-o" size={20} style={styles.usericon2}/>
         <Image
                style={styles.splashlayerimg2}
                source={require("../../assets/Rectangle.png")}
              /> 
             
         <TextInput placeholder={"Your name"} style={styles.Textinput2}/>
         
         <Feather name="mail" size={20} style={styles.usericon1}/>
         <Image
         ...
         <Image
                ...
                source={require("../../assets/Rectangle.png")}
              />
         <TextInput      placeholder={"Password"}     secureTextEntry={!hide}
...
By creating an account, you agree to the Kenakata 
<Text onPress={() =>
           {alert('Terms of service');}}
           style={styles.text3}> Terms of service </Text> 
<Text>and</Text>
<Text onPress={() =>
           {alert('Privacy policy');}}
           style={styles.text3}> privacy policy</Text>
 </Text>
          <View >
             
          <TouchableOpacity style={styles.Done} onPress={()=>props.navigation.navigate("Login")}>
          
         <Text style={styles.Getstartedtext}>Sign Up</Text></TouchableOpacity>
        </View>
        
           <Text style={styles.text2}>Already have an account?<TouchableOpacity onPress={()=>props.navigation.navigate("Login")}>
               <Text style={styles.text3}> Sign In</Text></TouchableOpacity></Text>
    </View>
    )
